...
class PlantsViewWidget extends StatefulWidget {
  const PlantsViewWidget({
    Key? key,
    this.catRef,
  }) : super(key: key);
  ...
  @override
  _PlantsViewWidgetState createState() => _PlantsViewWidgetState();
}

class _PlantsViewWidgetState extends State<PlantsViewWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CategoriesRecord>(
      stream: CategoriesRecord.getDocument(widget.catRef!),
      builder: (context, snapshot) {
        ...
        final plantsViewCategoriesRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        plantsViewCategoriesRecord.name!,
                            ...
                            child: StreamBuilder<List<PlantsRecord>>(
                              stream: queryPlantsRecord(
                                queryBuilder: (plantsRecord) => plantsRecord
                                    .where('catRef', isEqualTo: widget.catRef)
                                    .orderBy('Name'),
                              ),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
